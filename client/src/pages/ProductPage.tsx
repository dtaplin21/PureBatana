        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="lg:w-1/2">
              ...
              <ProductGallery images={["/images/batana-new.jpeg", "/images/batana-new.jpeg", "/images/batana-new.jpeg", "/images/batana-new.jpeg"]} />
            </div>
            ...
            <div className="lg:w-1/2">
              <div className="mb-8">
                ...
                <p className="text-2xl font-display font-bold">${(product.price < 100 ? product.price : product.price / 100).toFixed(2)}</p>
              </div>
